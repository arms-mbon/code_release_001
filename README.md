...
* Final ASV/OTU count tables, taxonomy tables and fasta files were generated for each gene's data set. These files can be found [here](https://github.com/arms-mbon/code_release_001/upload/main/final_count_taxonomy_fasta_files).
