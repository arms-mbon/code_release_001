...
samples$MaterialSampleID<-gsub("_rep","",samples$MaterialSampleID) # Remove the "_rep" strings in MaterialSampleID column
...
to_remove_samples<-c("ARMS_Eilat_Katza1_20181024_20200706_MF500",
                     "ARMS_Vigo_TorallaA_20190625_20191014_MF500",
                     "ARMS_Vigo_TorallaB_20190625_20191014_MF500",
                     "ARMS_Vigo_TorallaC_20190625_20191014_MF500",
                     "ARMS_Gdynia_GDY1_20180813_20191029_SF38_DMSO",
                     "ARMS_GulfOfPiran_Fornace_20180815_20181118_SF_ETOH")
...
to_remove_pres_COI <-c("ARMS_Crete_1HERP_20180928_20190128_MF125_ETOH",
                   "ARMS_Crete_1HERP_20180928_20190128_MF500_ETOH",
                   "ARMS_Crete_1HERP_20180928_20190128_SF_ETOH",
                   "ARMS_GulfOfPiran_Fornace_20180815_20181118_MF100_ETOH",
                   "ARMS_GulfOfPiran_Fornace_20180815_20181118_MF500_ETOH_rep",
                   "ARMS_GulfOfPiran_Fornace_20180815_20181118_SF_ETOH_rep",
                   "ARMS_Koster_VH2_20180418_20180906_SF40_ETOH",
                   "ARMS_Plymouth_MBA1_20180701_20181001_MF100_ETOH",
                   "ARMS_Plymouth_MBA1_20180701_20181001_MF500_ETOH",
                   "ARMS_Plymouth_MBA1_20180701_20181001_SF40_ETOH",
                   "ARMS_Plymouth_MBA2_20180701_20181001_SF40_ETOH",
                   "ARMS_Roscoff_BasBloS1_20180711_20181025_SF40_ETOH_A",
                   "ARMS_Roscoff_BasBloS1_20180711_20181025_SF40_ETOH_B",
                   "ARMS_Roscoff_MarBloR1_20180709_20181024_MF100_ETOH",
                   "ARMS_Roscoff_MarBloR1_20180709_20181024_MF500_ETOH",
                   "ARMS_Roscoff_MarBloR1_20180709_20181024_SF40_ETOH")
...
ps_roscoff_COI<-prune_samples(sample_names(psCOI) %in% c("ARMS_Roscoff_BasBloS1_20180711_20181025_SF40_DMSO_A","ARMS_Roscoff_BasBloS1_20180711_20181025_SF40_DMSO_B"), psCOI)
rarecurve(t(otu_table(ps_roscoff_COI)), step=50, cex=0.5)

# Remove the sample with lower sample size/ASV richness
psCOI <- prune_samples(!(sample_names(psCOI) %in% "ARMS_Roscoff_BasBloS1_20180711_20181025_SF40_DMSO_B"), psCOI)
...
to_remove_samples<-c("ARMS_Gdynia_GDY1_20180813_20191029_SF38_DMSO","ARMS_Koster_VH1_20190527_20200716_MF100_rep","ARMS_GulfOfPiran_Fornace_20180815_20181118_MF500_ETOH_rep")
...
to_remove_pres_18S <-c("ARMS_Crete_1HERP_20180928_20190128_MF125_ETOH",
                       "ARMS_Crete_1HERP_20180928_20190128_MF500_ETOH",
                       "ARMS_Crete_1HERP_20180928_20190128_SF_ETOH",
                       "ARMS_GulfOfPiran_Fornace_20180815_20181118_MF100_ETOH",
                       "ARMS_GulfOfPiran_Fornace_20180815_20181118_MF500_ETOH",
                       "ARMS_GulfOfPiran_Fornace_20180815_20181118_SF_ETOH_rep",
                       "ARMS_Koster_VH2_20180418_20180906_SF40_ETOH",
                       "ARMS_Plymouth_MBA1_20180701_20181001_MF100_ETOH",
                       "ARMS_Plymouth_MBA1_20180701_20181001_MF500_ETOH",
                       "ARMS_Plymouth_MBA1_20180701_20181001_SF40_ETOH",
                       "ARMS_Plymouth_MBA2_20180701_20181001_MF100_ETOH",
                       "ARMS_Plymouth_MBA2_20180701_20181001_SF40_ETOH",
                       "ARMS_Roscoff_BasBloS1_20180711_20181025_SF40_ETOH_A",
                       "ARMS_Roscoff_BasBloS1_20180711_20181025_SF40_ETOH_B",
                       "ARMS_Roscoff_MarBloR1_20180709_20181024_MF100_ETOH",
...
# Assess rarefaction curves to see which sample to keep
ps_roscoff_18S<-prune_samples(sample_names(ps18S) %in% c("ARMS_Roscoff_BasBloS1_20180711_20181025_SF40_DMSO_A","ARMS_Roscoff_BasBloS1_20180711_20181025_SF40_DMSO_B"), ps18S)
rarecurve(t(otu_table(ps_roscoff_18S)), step=50, cex=0.5)

# Remove the sample with lower sample size/OTU richness
ps18S <- prune_samples(!(sample_names(ps18S) %in% "ARMS_Roscoff_BasBloS1_20180711_20181025_SF40_DMSO_B"), ps18S)
...
to_remove_pres_ITS <-c("ARMS_Crete_1HERP_20180928_20190128_MF500_ETOH",
                       "ARMS_Crete_1HERP_20180928_20190128_SF_ETOH",
                       "ARMS_Koster_VH2_20180418_20180906_SF40_ETOH",
                       "ARMS_Plymouth_MBA2_20180701_20181001_MF100_ETOH")
...
phylum_COI_plot<-ggplot(phylum_COI, aes(x=Phylum, y=reads, fill=Phylum))+
  ...
  theme_bw()+
  theme(plot.margin=unit(c(.2,.5,0,2.2), "cm"),plot.title = element_text(size = 20, face = "bold",vjust=-.2),axis.title.x=element_blank(),axis.title.y=element_blank(),legend.position="none",axis.text.y=element_text(color="black"),axis.text.x=element_text(angle=45,hjust=1,color="black"),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
...
phylum_18S_plot<-ggplot(phylum_18S, aes(x=Phylum, y=reads, fill=Phylum))+
  ...
  theme_bw()+
  theme(plot.margin=unit(c(-0.3,.5,-0.3,2.2), "cm"),plot.title = element_text(size = 20, face = "bold",vjust=-.2),axis.title.x=element_blank(),legend.position="none",axis.text.y=element_text(color="black"),axis.text.x=element_text(angle=45,hjust=1,color="black"),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
...
phylum_ITS_plot<-ggplot(phylum_ITS, aes(x=Phylum, y=reads, fill=Phylum))+
  ...
  theme_bw()+
  theme(plot.margin=unit(c(0,.5,.2,2.2), "cm"),plot.title = element_text(size = 20, face = "bold",vjust=-.2),axis.title.y=element_blank(),axis.title.x=element_blank(),legend.position="none",axis.text.y=element_text(color="black"),axis.text.x=element_text(angle=45,hjust=1,color="black"),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),panel.border = element_blank())
...
specs_COI_plot<-ggplot(specs_COI, aes(x=Phylum, y=abundance, fill=Phylum))+
  ...
  ggtitle("B")+
  theme_bw()+
  theme(plot.margin=unit(c(.2,.2,0,0), "cm"),plot.title = element_text(size = 20, face = "bold",vjust=-.2),axis.title.x=element_blank(),axis.title.y=element_blank(),legend.position="none",axis.text.y=element_text(color="black"),axis.text.x=element_text(angle=45,hjust=1,color="black"),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),panel.border = element_blank())
...
specs_18S_plot<-ggplot(specs_18S, aes(x=Phylum.Class, y=abundance, fill=Phylum.Class))+
  ...
  theme_bw()+
  theme(plot.margin=unit(c(-0.3,.2,-0.3,0), "cm"),plot.title = element_text(size = 20, face = "bold",vjust=-.2),axis.title.x=element_blank(),legend.position="none",axis.text.y=element_text(color="black"),axis.text.x=element_text(angle=45,hjust=1,color="black"),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
...
specs_ITS_plot<-ggplot(specs_ITS, aes(x=Class, y=abundance, fill=Class))+
  ...
  ggtitle("F")+
  theme_bw()+
  theme(plot.margin=unit(c(0,.2,.2,0), "cm"),plot.title = element_text(size = 20, face = "bold",vjust=-.2),axis.title.x=element_blank(),axis.title.y=element_blank(),legend.position="none",axis.text.y=element_text(color="black"),axis.text.x=element_text(angle=45,hjust=1,color="black"),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),panel.border = element_blank())
...
ggsave(phylum_plot_genes,file="phylum_plot_gene_names.png",height=8,width=8,type="cairo")
...
### Get species occurrences and their respective coordinates to scan species lists against IUCN, AMBI and WRiMS ###
...
species_list_COI<-as.data.frame(cbind(otu_table(species_ps_COI),tax_table(species_ps_COI)[,7]))
species_list_COI<-species_list_COI %>% pivot_longer(cols=-Species,names_to = "ARMS", values_to = "count")
...
species_list_18S<-as.data.frame(cbind(otu_table(species_ps_18S),tax_table(species_ps_18S)[,10]))
species_list_18S<-species_list_18S %>% pivot_longer(cols=-Species,names_to = "ARMS", values_to = "count")

species_list<-rbind(species_list_COI,species_list_18S)
...
# IUCN and AMBI scan was then performed with a version of this resulting table containing only the accepted_name_aphia_worms and valid_aphiaid_worms columns.

# Make table for WRiMS scan

species_list_wrims<-rbind(species_list_COI,species_list_18S)
species_list_wrims[species_list_wrims$count!=0,3]<-"1" # Set all occurrences above zero to 1
species_list_wrims<-species_list_wrims %>% distinct()
species_list_wrims$Species<-gsub("_"," ",species_list_wrims$Species)
for(i in 1:nrow(samples)) { # add Observatory info
  species_list_wrims$Observatory[species_list_wrims$ARMS == samples$ARMS[i]] <- samples$Observatory[i]
} # will give a warning, just ignore
worms_match<-read.table("result_species_list.txt",header=T,sep="\t") # read the prepared results file from WoRMS Tacon Match procedure run on LifeWatch E-services
for(i in 1:nrow(worms_match)) { # Add accepted names from WoRMS and AphiaID
  species_list_wrims<-species_list_wrims %>% filter(Species %in% worms_match$scientificname)
  species_list_wrims$ScientificName_accepted[species_list_wrims$Species == worms_match$scientificname[i]] <- worms_match$accepted_name_aphia_worms[i]
  species_list_wrims$AphiaID_accepted[species_list_wrims$ScientificName_accepted == worms_match$accepted_name_aphia_worms[i]] <- worms_match$valid_aphiaid_worms[i]
} # will give a warnings, just ignore
species_list_wrims<-species_list_wrims %>% select(-Species)
species_list_wrims$count<-as.numeric(species_list_wrims$count)

# Create list with separate tables for each observatory
species_list_wrims<-species_list_wrims %>% group_split(Observatory)
species_list_wrims<-lapply(species_list_wrims,function(x) x %>% select(-Observatory))
species_list_wrims<-lapply(species_list_wrims, function(x) x %>% 
                             group_by(ARMS) %>% # First have to create a unique identifier row for each ARMS before using pivot_wider
                             mutate(row = row_number()) %>%
                             pivot_wider(names_from = ARMS, values_from = count,values_fill = 0) %>%
                             select(-row))
...
species_list_wrims<-lapply(species_list_wrims, function(x) x %>% relocate(c(NCBI_Tax.x_pr2,ScientificName_pr2,AphiaID_accepted)))
...
xlsx::write.xlsx(species_list_wrims[[1]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "BelgiumCoast", append = FALSE,row.names = F)
xlsx::write.xlsx(species_list_wrims[[2]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Bodo", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[3]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Crete", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[4]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Eilat", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[5]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Gdynia", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[6]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Getxo", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[7]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "GulfofPiran", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[8]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Koster", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[9]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Laeso", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[10]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Limfjord", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[11]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Plymouth", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[12]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Roscoff", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[13]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Svalbard", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[14]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "TZS", append = T,row.names = F)
xlsx::write.xlsx(species_list_wrims[[15]], file = "ARMS_species_WRiMS_check.xlsx",sheetName = "Vigo", append = T,row.names = F)
...
species_plot<-ggplot(ambi_red_list_wrims, aes(x = Observatory,y=value,fill=name)) +
  ...
  labs(y="Number of species")
ggsave(species_plot,file="ambi_red_list_wrims.png",height=3,width=5)
...
ggsave(species_plot_legend,file="ambi_red_list_wrims_legend.png",height=4,width=6)

# Outside of R, using any image processing software, manually change legend key size for Red list key, change space between legend items and add legend to first plot.
...
read_plot_COI<-ggplot(read_sums_COI, aes(x=reads, y=richness)) +
  ...
  theme_bw()+
  ggtitle("C")+
  theme(legend.title = element_blank(),plot.title = element_text(size = 20,face = "bold",vjust=-.2),axis.text.y=element_text(color="black"),axis.text.x=element_text(color="black",angle=45,hjust=1),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
...
ggsave(read_duration_plot,file="read_duration_plot.png",width=8,height=8,bg="white")
## Outside of R, using any image processing software, move x-axis title of A and B closer to x-axes
...
observatory_plot_COI<-ggplot(sums_merge_COI, aes(x=Observatory)) +
  ...
  theme_bw()+
  ggtitle("A")+
  theme(legend.key.size = unit(.75,"line"),axis.ticks.x = element_blank(),axis.title.x=element_blank(),legend.title = element_blank(),plot.title = element_text(size = 20,face = "bold",vjust=-.2),axis.text.y=element_text(color="black"),axis.text.x=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        axis.line = element_line(colour = "black"),panel.border = element_blank())+
...
observatory_plot_18S<-ggplot(sums_merge_18S, aes(x=Observatory)) +
  ...
  theme_bw()+
  ggtitle("B")+
  theme(legend.key.size = unit(.75,"line"),axis.title.x=element_blank(),legend.title = element_blank(),plot.title = element_text(size = 20,face = "bold",vjust=-.2),axis.text.y=element_text(color="black"),axis.text.x=element_text(color="black",angle=45,hjust=1),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        axis.line = element_line(colour = "black"),panel.border = element_blank())+
...
ggsave(observatory_plot,file="observatory_plot.png",width=6,height=6,bg="white")
...
ggsave(freq_plot,file="frequency_plot.png",width=7,height=5,bg="white")
# Use legend of observatory_plot.png, add it to this plot outside of R using any image processing software
...
## Compare diversity among habitat types ##
...
habitat<-cbind(rownames(samples),samples$Habitat)
colnames(habitat)<-c("Sample","Habitat")

COI_rich$Sample<-rownames(COI_rich)
COI_rich<-merge(COI_rich,habitat,by="Sample")

rich_18S$Sample<-rownames(rich_18S)
rich_18S<-merge(rich_18S,habitat,by="Sample")

# Make Industrial and Semi-industrial Habitat same group, as there are only a handful of Industrial samples 

COI_rich$Habitat<-ifelse(COI_rich$Habitat=="Industrial" | COI_rich$Habitat=="Semi-industrial","Industrial/Semi-industrial",COI_rich$Habitat)

rich_18S$Habitat<-ifelse(rich_18S$Habitat=="Industrial" | rich_18S$Habitat=="Semi-industrial","Industrial/Semi-industrial",rich_18S$Habitat)
...
# Check for normality and statistically compare ASV/OTU and species richness between Habitats
...
aov_COI_seq_rich<-aov(seq_rich_log ~ Habitat,COI_rich)
summary(aov_COI_seq_rich) # not significant

aov_COI_spec_rich<-aov(spec_rich ~ Habitat,COI_rich)
...
aov_18S_seq_rich<-aov(seq_rich ~ Habitat,rich_18S)
summary(aov_18S_seq_rich) # not significant

kruskal.test(spec_rich~Habitat,rich_18S) 

# Plots

COI_rich<-COI_rich %>% select(-seq_rich_sqrt)
COI_rich$spec_rich<-COI_rich$spec_rich*10
COI_rich<-COI_rich %>% pivot_longer(cols=-c(Sample,Habitat),names_to = "type", values_to = "richness")
COI_rich$type<-as.factor(COI_rich$type)

coi_plot<-ggplot(COI_rich, aes(x = Habitat)) +
  geom_boxplot(aes(y = richness, fill = type))+ 
  theme_classic()+
  ...
  ggtitle("A")+
  labs(x="Habitat type",y="ASV richness")

rich_18S$spec_rich<-rich_18S$spec_rich*20
rich_18S<-rich_18S %>% pivot_longer(cols=-c(Sample,Habitat),names_to = "type", values_to = "richness")
rich_18S$type<-as.factor(rich_18S$type)

plot_18S<-ggplot(rich_18S, aes(x = Habitat)) +
  geom_boxplot(aes(y = richness, fill = type))+ 
  theme_classic()+
  ...
  theme(legend.title = element_blank(),plot.title = element_text(size = 16,face = "bold",vjust=-.2),axis.title.x = element_blank(),axis.text.y=element_text(color="black"),panel.background = element_rect(fill = "transparent",colour = NA_character_),plot.background = element_rect(fill = "transparent",colour = NA_character_),legend.position="none",axis.text.x=element_text(angle=45,hjust=1,color="black"))+
  ggtitle("B")+
  labs(x="Habitat type",y="OTU richness")

richness_plot<-ggpubr::ggarrange(coi_plot,plot_18S,ncol=2,nrow=1,common.legend = T,legend="bottom",align="hv")

ggsave(richness_plot,file="richness_plot.png",width=7,height=5,bg="white")  
